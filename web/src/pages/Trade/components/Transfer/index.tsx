...
const Transfer: FC<any> = ({ isTransfer, coin, setIsTransfer }) => {
  ...
  return (
    <div>
      <Modal title="Bybit-划转" open={isTransfer} onOk={handleOk} onCancel={handleCancel} destroyOnClose={true}>
        <Form layout="horizontal" form={form}  >
          ...
          <Form.Item label="划转金额" name="amount" rules={[{ required: true, message: '划转金额必填！' }]}>
            <Input />
          </Form.Item>
          <Form.Item label="转出账户" name="from_account_type" rules={[{ required: true, message: '转出账户必填！' }]}>
            <Select>
              <Select.Option value="SPOT">现货</Select.Option>
              <Select.Option value="UNIFIED">统一保证金</Select.Option>
            </Select>
          </Form.Item>
          <Form.Item label="转入账户" name="to_account_type" rules={[{ required: true, message: '转入账户必填！' }]}>
            <Select>
              <Select.Option value="SPOT">现货</Select.Option>
              <Select.Option value="UNIFIED">统一保证金</Select.Option>
            </Select>
